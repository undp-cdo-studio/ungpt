              ...
              <a href="#0" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Terms</a> · <a href="#0" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Privacy Policy</a>
				...
				<div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
					...
					<ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
						<li>
							<a
								...
								target="_blank"
								className="flex justify-center items-center text-gray-900 hover:text-gray-700 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
								aria-label="Twitter"
								rel="noreferrer"
							>
								<svg
					...
					<div className="text-sm text-white mr-4">
						&copy; 2025 United Nations Development Programme.
					</div>
				</div>
			</div>
		</footer>
